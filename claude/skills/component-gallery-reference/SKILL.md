...
3. **tactical-polish** - Apply tactical polish. Concentric radii, optical alignment, animation timing, hit areas.

The gallery prevents functional gaps (missing keyboard handling, wrong semantics, inaccessible markup). Sidecoach prevents strategic gaps (off-brand, wrong register). Tactical-polish prevents polish gaps (janky animations, misaligned icons, wrong cursor). All three layers together produce components that work correctly, look native to the project, and feel polished.
