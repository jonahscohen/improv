...
- [Sprint 6 closed (2026-05-24)](session_2026-05-24_sprint6_closed.md): Phase 6 part 2 checkpoint mechanism - CheckpointStore module, auto-write between steps, metadata.resumeFromCheckpoint resume AP…
- [Sidecoach Audit Complete (2026-05-23)](../sidecoach/.claude/memory/session_2026-05-23_sidecoach_audit.md) - 85% backend complete (36 flows, 159 rules, 5 reference systems, full orchestration), 0%…
...
- [Ghostty placeholder + discord auto-wire](session_2026-04-14_portability-fixes.md) - Fixed ghostty path-pong (copy + placeholder), auto-wire discord source line into .zshrc with path-based idempote…
- [Behavioral failures - choice offering and skipping ahead](~/.claude/memory/session_2026-05-22_behavioral-failures.md) - Three critical pattern failures: text-form choices instead of AskUserQuestio…
...
- [Memory scope check](feedback_memory_scope_check.md) - Before writing memory, ask "project-only or every project?" - global lessons live in claude-dotfiles/claude/memory/ and symlink from ~/.claude…
