...
async function run() {
  console.log('Connecting to endow server...');
  ...
  // The server's endow_respond tool broadcasts to all clients
  ...
  // The real flow would be: Claude calls endow_respond MCP tool -> server broadcasts
  ...
  console.log('  - Response listener ready for endow_response events');
  console.log('\nNote: Full loop test requires Claude Agents session with endow MCP tools');
