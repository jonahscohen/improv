...
export class PromptMode {
  ...
  activate() {
    ...
    if (!this._queueBtn) {
      ...
      this._queueCount.style.cssText = "font-size:13px;font-weight:700;font-family:EndowSans,system-ui,sans-serif;font-variant-numeric:tabular-nums;pointer-events:none;line-height:1;color:#D97757";
      ...
      this._queueLabel.style.cssText = "font-size:14px;font-weight:500;color:rgba(255,255,255,0.85);white-space:nowrap;overflow:hidden;transition:width 0.35s cubic-bezier(0.4,0,0.2,1),opacity 0.25s ease;font-family:EndowSans,system-ui,sans-serif;display:none;cursor:pointer";
  ...
  submitPrompt(e: string) {
    ...
    this.transport.request("push_prompt", promptData).catch(function (e: unknown) {
      console.warn('[Endow] Submit failed:', e);
  ...
  _restoreQueuePanelReferences() {
    ...
    const existingPanel = container.querySelector('[data-endow-queue-panel]') as HTMLDivElement;
  ...
  _toggleQueuePanel() {
    ...
    alertTitle.style.cssText = "font-size:13px;font-weight:700;font-family:EndowSans,system-ui,sans-serif;color:rgba(255,255,255,0.85);margin-bottom:8px;display:flex;align-items:center";
    ...
    alertBody.style.cssText = "font-size:11px;font-family:EndowSans,system-ui,sans-serif;color:rgba(255,255,255,0.6);line-height:1.4";
    alertBody.appendChild(document.createTextNode('Tell Claude '));
    var alertCode = document.createElement("span");
    alertCode.style.cssText = "font-family:EndowMono,ui-monospace,monospace;font-size:11px;background:rgba(255,255,255,0.06);padding:2px 6px;border-radius:4px;color:rgba(255,255,255,0.8)";
    alertCode.textContent = "watch endow";
    ...
    clearAllBtn.style.cssText = "flex:1;height:36px;border-radius:8px;border:1px solid rgba(255,255,255,0.12);background:rgba(255,255,255,0.04);color:rgba(255,255,255,0.65);font-family:EndowSans,system-ui,sans-serif;font-size:12px;font-weight:500;cursor:pointer;transition:background 0.15s,color 0.15s,border-color 0.15s";
    ...
    sendAllBtn.style.cssText = "flex:1;height:36px;border-radius:8px;border:1px solid rgba(217,119,87,0.25);background:rgba(217,119,87,0.1);color:#D97757;font-family:EndowSans,system-ui,sans-serif;font-size:12px;font-weight:500;cursor:pointer;transition:background 0.15s,color 0.15s,border-color 0.15s";
  ...
  _confirmRemoveItem(idx: number) {
    ...
    box.style.cssText = "background:#1a1a1a;border:1px solid rgba(255,255,255,0.1);border-radius:12px;padding:20px;max-width:300px;font-family:EndowSans,system-ui,sans-serif;box-shadow:0 8px 32px rgba(0,0,0,0.5)";
    ...
    cancel.style.cssText = "border:1px solid rgba(255,255,255,0.15);background:none;color:rgba(255,255,255,0.65);border-radius:8px;padding:6px 14px;font-size:12px;cursor:pointer;font-family:EndowSans,system-ui,sans-serif";
    ...
    confirmBtn.style.cssText = "border:none;background:#ef4444;color:#fff;border-radius:8px;padding:6px 14px;font-size:12px;cursor:pointer;font-family:EndowSans,system-ui,sans-serif;font-weight:600";
