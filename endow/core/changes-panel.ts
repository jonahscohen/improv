...
export class ChangesPanel {
  ...
  constructor(shadowRoot: ShadowRoot, getMarkerColor: () => string) {
    ...
    this.container.style.cssText =
      ...
      'z-index:2147483647;pointer-events:all;font-family:"EndowSans",system-ui,sans-serif;' +
    ...
    this._clearReviewedBtn.style.cssText =
      ...
      'padding:6px 14px;border-radius:8px;font-family:EndowSans,system-ui,sans-serif;outline:none;transition:background 120ms ease,color 120ms ease,border-color 120ms ease';
  ...
  private startReply(index: number) {
    ...
    let replyWrap = item.querySelector('.endow-reply-wrap') as HTMLDivElement;
    if (replyWrap) { replyWrap.remove(); return; }

    replyWrap = document.createElement('div');
    replyWrap.className = 'endow-reply-wrap';
    ...
    input.style.cssText =
      ...
      'font-family:EndowSans,system-ui,sans-serif;min-width:0';
  ...
  private _showDetailContent(entry: ChangeEntry, index: number) {
    ...
    backBtn.style.cssText =
      ...
      'font-family:EndowSans,system-ui,sans-serif;outline:none;flex-shrink:0;' +
    ...
    numLabel.style.cssText =
      ...
      'font-family:EndowSans,system-ui,sans-serif;margin-right:8px;vertical-align:middle';
    ...
    changesByFile.forEach((fileChanges, filename) => {
      ...
      fileHeader.style.cssText =
        'font-size:12px;color:rgba(255,255,255,0.5);font-family:EndowSans,system-ui,sans-serif;' +
      ...
      chevSide.addEventListener('click', (e) => {
        ...
        for (const ed of editors) {
          ...
          row.style.cssText =
            ...
            'font-size:12px;font-family:EndowSans,system-ui,sans-serif;outline:none;' +
      ...
      for (const c of fileChanges) {
        ...
        selectorEl.style.cssText =
          'font-size:10px;color:rgba(255,255,255,0.35);font-family:EndowMono,ui-monospace,monospace;' +
        ...
        oldLine.style.cssText =
          'font-size:12px;font-family:EndowMono,ui-monospace,monospace;' +
  ...
  private render() {
    ...
    this.filteredEntries.forEach((entry, i) => {
      ...
      if ((entry.changes || []).length > 0) {
        ...
        statsSpan.style.cssText = 'font-size:11px;font-family:EndowMono,ui-monospace,monospace';
  ...
  private makeActionBtn(label: string, onClick: () => void): HTMLButtonElement {
    ...
    btn.style.cssText =
      ...
      'font-family:EndowSans,system-ui,sans-serif;transition:background 120ms ease;outline:none';
