...
const cssVars = {
  surface: '--endow-surface',
  surfaceHover: '--endow-surface-hover',
  text: '--endow-text',
  textSecondary: '--endow-text-secondary',
  textTertiary: '--endow-text-tertiary',
  border: '--endow-border',
  inputBg: '--endow-input-bg',
  blueBg: '--endow-blue-bg',
  blueText: '--endow-blue-text',
  blue500: '--endow-blue-500',
  surfaceActive: '--endow-surface-active',
  black: '--endow-black',
  white: '--endow-white',
};
...
const FONT_FAMILY = "'EndowSans', system-ui, sans-serif";
...
.endow-pp-panel::-webkit-scrollbar { display: none; }`;
    this.shadow.appendChild(style);
    this.container.classList.add('endow-pp-panel');
  }
  ...
  private buildTree(el: HTMLElement, depth: number): TreeNode {
    ...
    for (let i = 0; i < el.children.length; i++) {
      ...
      if (!child || child.nodeType !== 1 || child.tagName === 'ENDOW-PANEL' || child.classList.contains('endow-pp-panel')) continue;
