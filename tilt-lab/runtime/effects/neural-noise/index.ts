...
// matrix/sigmoid network evaluated per pixel with three time-driven sinusoidal
// inputs. The ~50 mat4 weight blocks are baked constants copied byte-for-byte from
// NeuralNoiseScene.svelte and define the entire look. Distinct from lane-2's
// "neuro-noise" (organic glow lines). Original Scene owns a RAF; tilt-lab drives
// frame(t). MIT-licensed; ok here.
