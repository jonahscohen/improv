...
const handler = async (input, deps) => {
    if (!deps.registries.verbs) {
        throw new errors_1.SidecoachToolError('DOWNSTREAM_UNAVAILABLE', 'verbs registry is not loaded (sidecoach-verbs.json missing or unreadable at startup)', { resource: 'sidecoach-verbs.json' });
    }
...
//# sourceMappingURL=list-verbs.js.map