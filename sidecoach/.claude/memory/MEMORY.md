...
- [Phase 2 Enhancement Task 8 Progress](session_2026-05-23_phase2_task8.md) - Rich taxonomy for /sidecoach list: CommandInfo interface added, phase field (Research/Implement/Review/Special), getCommandsByPhase() function for grouping
