...
exports.Flow10ImplementHandler = exports.Flow7DesignHandler = exports.Flow5ReviewHandler = exports.Flow2PolishHandler = void 0;
 ...
 */
class Flow2PolishHandler extends flow_handler_1.BaseFlowHandler {
    constructor() {
...
exports.Flow2PolishHandler = Flow2PolishHandler;
/**
 * Flow 5: Review/QA Mode
 * Consolidates audit - comprehensive multi-lens check
 */
class Flow5ReviewHandler extends flow_handler_1.BaseFlowHandler {
    constructor() {
...
exports.Flow5ReviewHandler = Flow5ReviewHandler;
/**
 * Flow 7: Design a New Component
 * Consolidates /sidecoach craft + QA triad (audit → critique → polish)
 */
class Flow7DesignHandler extends flow_handler_1.BaseFlowHandler {
    constructor() {
...
exports.Flow7DesignHandler = Flow7DesignHandler;
/**
 * Flow 10: Implement from Design
 * Design-to-code workflow with state matrix and responsive validation
 */
class Flow10ImplementHandler extends flow_handler_1.BaseFlowHandler {
    constructor() {
...
exports.Flow10ImplementHandler = Flow10ImplementHandler;
