...
async function run() {
    ...
    const handler = new flow_handler_design_tokens_1.FlowFDesignTokensHandler();
    const ctx = {
    ...
    const handler2 = new flow_handler_design_tokens_1.FlowFDesignTokensHandler();
    ...
    const listHandler = new flow_handler_design_tokens_1.FlowFDesignTokensHandler();
    ...
    assertEqual(paletteDef?.examples, ['colors.palette.name', 'colors.palette.value', 'colors.palette.name'], 'colors list-of-maps example paths');
    ...
    const scalarHandler = new flow_handler_design_tokens_1.FlowFDesignTokensHandler();
    ...
    assertEqual(breakpointsDef?.examples, ['breakpoints[0]', 'breakpoints[1]', 'breakpoints[2]'], 'breakpoints scalar example paths');
...
//# sourceMappingURL=design-tokens-count.test.js.map