...
async function testOpenAiAdapter() {
    ...
    const echoed = await (0, image_generation_1.callProvider)(image_generation_1.OPENAI_PROVIDER, REQ, 'k', fixedTransport(401, { error: { message: 'Incorrect API key provided: sk-proj-********************pSZg. You can find your API key at https://platform.openai.com/account/api-keys.' } }));
