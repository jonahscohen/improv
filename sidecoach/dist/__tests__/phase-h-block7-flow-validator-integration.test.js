...
function testBlock7a() {
    ...
    results.push({
        ...
        passed: flow_domain_validators_1.COMPOSITE_FLOW_VALIDATIONS.complete_qa_workflow.domains.length === 5 &&
...
function testBlock7b() {
    ...
    results.push({
        ...
        passed: validations4[0]?.status === 'partial' &&
    ...
    results.push({
        ...
        passed: validations5.length === 4 &&
            ['accessibility', 'performance', 'design_system', 'semantic'].every(d => validations5.some(v => v.domain === d)),
    });
...
function testBlock7c() {
    ...
    results.push({
        ...
        passed: validations3.length === workflowDomains3.length &&
