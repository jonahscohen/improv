...
async function run() {
    ...
    await engine.process('hello sidecoach', { projectPath: sandbox, projectContext: { register: 'brand' } });
    ...
    await engine.process('hello again', { projectPath: sandbox, projectContext: { register: 'brand' } });
...
//# sourceMappingURL=sprint6-checkpoint-engine-gc.test.js.map