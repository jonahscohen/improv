...
exports.FontshareReferenceImpl = void 0;
exports.createFontshareReference = createFontshareReference;
const reference_data_1 = require("./reference-data");
class FontshareReferenceImpl {
    constructor() {
    ...
    async getFontCandidates(typography, register) {
        ...
        for (const fontName of fontNames) {
            ...
            const candidate = {
                ...
                category: (font.personality[0] || 'sans-serif'),
...
exports.FontshareReferenceImpl = FontshareReferenceImpl;
function createFontshareReference() {
    return new FontshareReferenceImpl();
}
//# sourceMappingURL=fontshare-reference.js.map