 ...
 * this chain in order.
 */
export declare const DEFAULT_RALPH_FLOW_CHAIN: FlowId[];
export declare const DEFAULT_RALPH_MAX_GLOBAL_ITERATIONS = 10;
export declare const DEFAULT_RALPH_MAX_NO_PROGRESS_ITERATIONS = 3;
 ...
 */
export declare function computeProgressSignature(findings: RalphFinding[]): string;
/**
 ...
 */
export declare function extractFindingsFromFlowResult(flowId: FlowId, result: FlowExecutionResult): RalphFinding[];
/**
 * Run a relentless cross-flow loop against `target`. See module header for
 * the contract and the auto-fix gap discussion.
 */
export declare function runRalphLoop(target: string, opts?: RalphOptions): Promise<RalphResult>;
/**
