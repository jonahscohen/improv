...
class FlowGComponentImplementationHandler extends flow_handler_1.BaseFlowHandler {
    ...
    async execute(context) {
        ...
        try {
            ...
            const assetChecklistItem = (0, image_asset_production_1.assetProductionChecklistItem)(assetOutcome, (0, image_brief_compiler_1.briefWantsRaster)(context.utterance || ''));
            ...
            const memoryBuilder = new flow_memory_schema_1.FlowMemoryBuilder(this.flowId, this.getFlowName())
                ...
                .addValidation('Raster asset produced and verified', (0, image_asset_production_1.assetProductionValidationStatus)(assetChecklistItem), assetOutcome ? assetOutcome.detail : 'asset lens did not run (no project path)')
