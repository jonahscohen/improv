...
import { directionById, type Direction } from './direction-deck';

// ---------------------------------------------------------------------------
// Direction resolution (fail-loud: an unknown or duplicate id is an error, never a silent drop)
// ---------------------------------------------------------------------------
 ...
 */
export function resolveDirections(ids: readonly string[]): ResolveResult {
 ...
 */
export function renderDeckMarkdown(directions: readonly Direction[], opts: PresentOptions = {}): string {
...
function directionCard(d: Direction, index: number): string {
 ...
 */
export function renderDeckArtifactHtml(directions: readonly Direction[], opts: PresentOptions = {}): string {
