...
import { ENFORCED_RULES } from './validators/enforced-rules.generated';
import { tasteBlockingEnabled } from './validators/taste-blocking-toggle';
...
const MINED_ENFORCED_RULES: ProductRuleDefinition[] = ENFORCED_RULES.map((r) => {
  if (tasteBlockingEnabled()) return r;
  ...
  return { ...r, severity: 'advisory' as CanonicalSeverity, severityOverrideReason: reason };
});

const RAW_RULES: ProductRuleDefinition[] = [...BUILTIN_RULES, ...MINED_ENFORCED_RULES];
