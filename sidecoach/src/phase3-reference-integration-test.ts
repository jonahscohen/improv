...
async function testPhase3References() {
  ...
  try {
    ...
    const flowB = new FlowBComponentResearchHandler();
    ...
    const flowC = new FlowCFontResearchHandler();
    ...
    const flowD = new FlowDReferenceSearchHandler();
    ...
    const flowE = new FlowEMotionPatternsHandler();
