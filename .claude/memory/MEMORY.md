- [P4 re-sequence: lane_converge + MCP before browser collector - DECISION (2026-06-14)](session_2026-06-14_p4-resequence-convergence-first.md): browser collector = new heavy Playwright dep + lowest value; do P4c (lane_converge) + P4d (MCP) first, defer P4b-2
- [P4b-1 lock: 4 reviews failed (even proper-lockfile); Jonah chose ship-best-effort+document; flock deferred - PROJECT (2026-06-14)](session_2026-06-14_p4b1-lock-decision.md): P4b-1 lock: 4 reviews failed (even proper-lockfile); Jonah chose ship-best-effort+document; flock deferred
- [P4b-1 COMPLETE (merged) - async validator gating + lease/outbox durability; lock=best-effort proper-lockfile (Jonah call); known rare timing-flake w/ remediation - PROJECT (2026-06-14)](session_2026-06-14_p4b1-COMPLETE.md): P4b-1 COMPLETE (merged) - async validator gating + lease/outbox durability; lock=best-effort proper-lockfile (Jonah call); known rare timing-flake w/ remediation
- [P4b-1 plan P0 lock-ABA -> Codex authors v2, I review; LaneSideEffectSink scope call - PROJECT (2026-06-13)](session_2026-06-13_p4b1-codex-review-handoff.md): P4b-1 plan P0 lock-ABA -> Codex authors v2, I review; LaneSideEffectSink scope call
- [P4b-1 v2 (Codex-authored) reviewed+APPROVED - race-safe rename-lock verified; executing durability+gating - PROJECT (2026-06-13)](session_2026-06-13_p4b1-v2-approved.md): P4b-1 v2 (Codex-authored) reviewed+APPROVED - race-safe rename-lock verified; executing durability+gating
