- [P4a-2 code review (Codex): core confirmed, 4 coverage/finding fixes - PROJECT (2026-06-13)](session_2026-06-13_p4a2-code-review.md): P4a-2 code review (Codex): core confirmed, 4 coverage/finding fixes
- [P4a-2 COMPLETE (merged) - partial-static validator floor; Codex-authored plan + code-review; honesty boundary (cross-file -> inconclusive until P4b) - PROJECT (2026-06-13)](session_2026-06-13_p4a2-COMPLETE.md): P4a-2 COMPLETE (merged) - partial-static validator floor; Codex-authored plan + code-review; honesty boundary (cross-file -> inconclusive until P4b)
