...
- [x] M11 reference.html with tabs - 9 component tabs (improv/sidecoach/memory/cmux/voice/discord/hooks/impeccable/validation-guard), left-rail sticky tab list on desktop, horizontal scrollable on mobile, ARIA tabs pattern with keyboard nav (arrows, home, end), URL fragment sync. JS minimal, no synthetic events.
