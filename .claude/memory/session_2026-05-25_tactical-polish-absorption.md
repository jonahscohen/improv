---
name: tactical-polish absorption into sidecoach reference library
description: Extracting tactical-polish skill into sidecoach/reference/_extracted/ with verbatim lift + extension + gaps per file
type: project
relates_to: []
---

Extracting tactical-polish's 5 source files into sidecoach reference library at `/Users/spare3/Documents/Github/claude-dotfiles/sidecoach/reference/_extracted/tactical-polish/`.

Source location: `/Users/spare3/.agents/skills/tactical-polish/`
- SKILL.md (148 lines)
...
Format per file: VERBATIM lift first, then Extension (increasing specificity with reasoning behind exact values), then What's missing (gaps in tactical-polish coverage).
...
- performance.md: written. transition specificity + will-change verbatim. Extension covers 6-row safe-vs-dangerous Tailwind class table, cascade hazard explanation, CI grep test, when-to-add and when-NOT-to-add will-change rules, 15-row GPU-compositable property table (transform/opacity/filter/clip-path Yes; layout-triggering No; paint-only No), GPU memory cost math (300x200 card = 240KB, 50 cards = 12MB), Safari-specific benefit, scoped application via active-state class pattern. 17 named gaps: frame budget/60fps, Layout-Paint-Composite model, reflow avoidance, bundle size, image perf, layout shift prevention (only tabular-nums in tactical-polish), critical CSS, font loading perf, network/resource hints, JS animation performance, memory leaks, concurrent animation limits, low-end device strategy, GPU memory budget, profiling tools, SSR perf, build-time vs runtime CSS cost.
...
- /Users/spare3/Documents/Github/claude-dotfiles/sidecoach/reference/_extracted/tactical-polish/SKILL.md
- /Users/spare3/Documents/Github/claude-dotfiles/sidecoach/reference/_extracted/tactical-polish/typography.md
- /Users/spare3/Documents/Github/claude-dotfiles/sidecoach/reference/_extracted/tactical-polish/surfaces.md
- /Users/spare3/Documents/Github/claude-dotfiles/sidecoach/reference/_extracted/tactical-polish/animations.md
- /Users/spare3/Documents/Github/claude-dotfiles/sidecoach/reference/_extracted/tactical-polish/performance.md
- /Users/spare3/Documents/Github/claude-dotfiles/.claude/memory/session_2026-05-25_tactical-polish-absorption.md
...
- /Users/spare3/Documents/Github/claude-dotfiles/sidecoach/reference/_extracted/tactical-polish/SKILL.md (created)
- /Users/spare3/Documents/Github/claude-dotfiles/.claude/memory/session_2026-05-25_tactical-polish-absorption.md (this file)
