---
name: Impeccable absorption into sidecoach (COMPLETE)
description: Verbatim+extension extraction of all 36 impeccable files into sidecoach/reference/_extracted/impeccable/ with verbatim lift, extension specificity, and gap analysis per file
type: project
...
All 36 source files from `/Users/spare3/.claude/plugins/cache/impeccable/impeccable/3.1.1/skills/impeccable/` extracted to `/Users/spare3/Documents/Github/claude-dotfiles/sidecoach/reference/_extracted/impeccable/`.
...
Tree:
```
sidecoach/reference/_extracted/impeccable/
  SKILL.md
  reference/
    adapt.md
    animate.md
